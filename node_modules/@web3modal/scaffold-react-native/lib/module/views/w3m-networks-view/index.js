...
import { CardSelect, CardSelectWidth, FlexView, Link, Separator, Spacing, Text } from '@web3modal/ui-react-native';
import { ApiController, AssetUtil, NetworkController, RouterController, AccountController } from '@web3modal/core-react-native';
...
export function NetworksView() {
  ...
  const networksTemplate = () => {
    ...
    return requested.map(network => /*#__PURE__*/React.createElement(View, {
      key: network.id,
