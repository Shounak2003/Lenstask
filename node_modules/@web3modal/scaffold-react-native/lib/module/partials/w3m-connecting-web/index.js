...
import { RouterController, ApiController, AssetUtil, ConnectionController, CoreHelperUtil, OptionsController } from '@web3modal/core-react-native';
import { Button, FlexView, LoadingThumbnail, Text, WalletImage, Link, IconBox } from '@web3modal/ui-react-native';
import styles from './styles';
export function ConnectingWeb(_ref) {
  let {
    onCopyUri
  } = _ref;
  const {
