...
export declare const getThemedStyle: (theme: {
    "accent-100": string;
    "accent-090": string;
    "accent-020": string;
...
}, variant: Exclude<ButtonType, 'accent'>, pressed: boolean, disabled?: boolean) => {
    borderColor: string;
    backgroundColor: string;
};
export declare const getTextColor: (variant: Exclude<ButtonType, 'accent'>, disabled?: boolean) => ColorType;
